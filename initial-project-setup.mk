...
.PHONY: create-develop-branch
create-develop-branch:
	@if git show-ref --verify --quiet "refs/remotes/origin/develop"; then \
		echo "\n🚀 'develop' branch already exists in the remote repository"; \
	else \
...
.PHONY: clean
clean:
	@echo "\n🚀 Cleaning up initial project setup"
	rm -f initial-project-setup.mk

.PHONY: dependency-install
dependency-install: pre-commit-install pyenv-install poetry-install

# Checks and installs the required dependencies, creates a virtual environment, install pre-commit hooks, creates a develop branch, and removes this file.
.PHONY: project-setup
project-setup: dependency-install env-setup pre-commits create-develop-branch clean
